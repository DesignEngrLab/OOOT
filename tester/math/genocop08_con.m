function [C,Ceq]=genocop08_con(x)
%function:
...
%
%reference:
%note that you can get the formulation of genocop08_con from some
%aritcles,such as
...
Ceq(1,1)=x1+2*x2+2*x3+x6+x10-2;
Ceq(2,1)=x4+2*x5+x6+x7-1;
Ceq(3,1)=x3+x7+x8+2*x9+x10-1;
